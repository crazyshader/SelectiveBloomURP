...
[CustomPropertyDrawer(typeof(CustomBlit.BlitSettings))]
public class CustomBlitEditor : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        EditorGUILayout.PropertyField(property.FindPropertyRelative("filterSettings"));
        EditorGUILayout.PropertyField(property.FindPropertyRelative("bloomSettings"));
        ...
        if (enumValue == (int)CustomBlit.Target.TextureID) {
            EditorGUILayout.PropertyField(property.FindPropertyRelative("srcTextureId"));
        } else if (enumValue == (int)CustomBlit.Target.RenderTextureObject) {
