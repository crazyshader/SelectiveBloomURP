...
namespace GameFramework.Task
{
	...
	public sealed class ConditionalTask : TaskBase
	{
		...
		private Action<ConditionalTask, string> m_CompleteAction;
		private Action<ConditionalTask, string> m_FailureAction;
		private Action<ConditionalTask, string> m_CancelAction;
