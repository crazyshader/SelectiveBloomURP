...
namespace GameFramework.Setting
{
    ...
    /// 配置管理器。
    /// </summary>
    public sealed class SettingManager : MonoSingleton<SettingManager>
    {
        private DefaultSettingHelper m_SettingHelper;
        ...
        {
            m_SettingHelper = (new GameObject("Setting Helper")).AddComponent<DefaultSettingHelper>();
            if (m_SettingHelper == null)
            {
                Log.Warning("Can not create setting helper.");
                return;
            }

            m_SettingHelper.transform.SetParent(transform);
        }
        ...
        public void SetSettingHelper(DefaultSettingHelper settingHelper)
        {
